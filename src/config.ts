...
export const themeConfig: ThemeConfig = {
  ...
  site: {
    ...
    favicon: '/icons/avatar.png', // or https://example.com/favF.svg
  ...
  comment: {
    ...
    // https://giscus.app/
    giscus: {
      repo: 'L0ne1y4Ever/astro-blog',
      repoId: 'R_kgDORQRiqA',
      category: 'General',
      categoryId: 'DIC_kwDORQRiqM4C2fHT',
      mapping: 'pathname',
      strict: '0',
      reactionsEnabled: '1',
      emitMetadata: '0',
  ...
  seo: {
    ...
    umamiAnalyticsID: 'd171a498-13f6-4e62-80ad-86d5521dce96',
    // follow verification
    // https://follow.is/
    follow: {
      // feed ID
  ...
  footer: {
    ...
    links: [
      ...
      {
        name: 'GitHub',
        url: 'https://github.com/L0ne1y4Ever',
      },
      {
        name: 'Email',
  ...
  preload: {
    ...
    customUmamiAnalyticsJS: 'https://cloud.umami.is/script.js',
  },
